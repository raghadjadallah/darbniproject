...
public class MainTrainerScreen extends AppCompatActivity {
    ...
    public void searchForCenterMethod(View view) {
        // with this method we going to allow users start searching for centers
        // by moving to new screen that display by default all available center in the
        // application
        Intent moveToStarSearching=new Intent
                (MainTrainerScreen.this,SearchForCenter.class);
        startActivity(moveToStarSearching);
    }
